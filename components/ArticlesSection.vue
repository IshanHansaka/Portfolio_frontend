<template>
    <div class="min-h-screen px-10 pt-[90px] md:pt-[50px] pb-[100px] flex justify-center items-center">
        <div class="pt-[30px]">
            ...
            <div class="flex overflow-x-auto space-x-2">
                <div class="p-4 flex-shrink-0" v-for="blog in blogs" :key="blog.title">
                    <ArticleCard :article="{
                        title: blog.title,
